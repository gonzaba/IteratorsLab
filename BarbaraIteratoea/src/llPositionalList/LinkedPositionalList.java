...
public class LinkedPositionalList<E> implements PositionalList<E> {
	...
	private static class DNode<E> implements Position<E> { 
		...
		private LinkedPositionalList<E> myList;
		...
		public void setList(LinkedPositionalList<E> m) {
			myList = m;
		}
	...
	private DNode<E> validate(Position<E> p) throws IllegalArgumentException { 
		...
		if (p==null) 
			throw new  IllegalArgumentException("Invalid position: null reference."); 
	
		try {
			DNode<E> node = (DNode<E>) p;
			if (node.getPrev()==null || node.getNext()==null)    
				throw new  IllegalArgumentException("Not a valid data position."); 
			...
			throw new  IllegalArgumentException("Position is not of type DNode"); 
		}
